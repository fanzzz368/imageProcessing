 ...
 * controller to call Greyscale and performs the appropriate command, making the image grey.
 */
public class Greyscale implements ImageProcessingCommand {
   ...
   */
  public Greyscale(String previousName, String newName) {
